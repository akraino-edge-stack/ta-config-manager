...
PLATFORM_AUDIT_DISK_RATIO = 0.25
...
class Config(config.Config):
    ...
    def get_caas_max_audit_size(self):
        if self.is_hybrid_deployment() or self.get_caas_only():
            return AUDIT_DISK_LIMIT*PLATFORM_AUDIT_DISK_RATIO
        else:
            return 0
    ...
    def get_audit_disk_ratio(self):
        return PLATFORM_AUDIT_DISK_RATIO
